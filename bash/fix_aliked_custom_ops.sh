FILE1="../methods/aliked/custom_ops/get_patches_cuda.cu"
FILE2="../methods/aliked/custom_ops/get_patches.cpp"  # if it exists
...
# build
cd ../methods/aliked/custom_ops && sh build.sh
